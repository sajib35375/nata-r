...
class OtherController extends Controller
{
    ...
    public function applyUpdate(Request $request,$id){
        ...
        if ($request->hasFile('photo')){
            ...
            Image::make($image)->resize(700,800)->save('NATA_files/image/'.$unique_name);
        ...
        $update_data->p_division = $request->division;
        $update_data->p_district = $request->district;
        $update_data->p_upozila = $request->upozilla;
        ...
        $update_data->a_divisaion = $request->division_id_per;
        $update_data->b_district = $request->district_id_per;
        $update_data->c_upozila = $request->upozila_id_per;
