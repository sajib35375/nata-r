...
class CreateAppliesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('applies', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('p_division');
            $table->unsignedBigInteger('p_district');
            $table->unsignedBigInteger('p_upozila');
            ...
            $table->unsignedBigInteger('a_divisaion');
            $table->unsignedBigInteger('b_district');
            $table->unsignedBigInteger('c_upozila');
