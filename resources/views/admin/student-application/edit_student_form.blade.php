...
@section('content')
    ...
    <div class="box" style="margin: 10px;">
        ...
        <div class="box-header with-border">
            <h1 class="box-title">Edit Applicant Form</h1>
        </div>
        <hr>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="organization_name" type="text" class="form-control" value="{{ $edit_data->organization_name }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6" >
                        <div class="form-group form-group-float">
                            <label class="form-group-float-label">Cadre number/non-cadre</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-float">
                            <label class="form-group-float-label">Upozila</label>
                            <select name="upozilla" class="form-control" required>
                                <option value="">select</option>
                                @foreach($upozila as $upo)
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-float">
                            ...
                            <select name="division_id_per" class="form-control" required>
                                <option value="">select</option>
                                @foreach($perdivision as $per_div)
                                <option {{ $per_div->id == $edit_data->a_divisaion ? 'selected' : '' }} value="{{ $per_div->id }}">{{ $per_div->division_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group form-group-float">
                            ...
                            <select name="district_id_per" class="form-control" required>
                                <option value="">select</option>
                                @foreach($perdistrict as $perdis)
                                <option {{ $perdis->id==$edit_data->b_district ? 'selected' : '' }} value="{{ $perdis->id }}">{{ $perdis->district_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group form-group-float">
                            ...
                            <select name="upozila_id_per" class="form-control" required>
                                <option value="" selected="">select</option>
                                @foreach($perupozila as $perupo)
                                <option {{ $perupo->id == $edit_data->c_upozila ?'selected' : '' }} value="{{ $perupo->id }}">{{ $perupo->upozila_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
