        ...
        <div class="row">
            ...
            <div id="lsb" class="animate-left col-sm-3 sidenav ">
                <div class="panel panel-default drop-shadow">
                    <div class="panel-heading text-center" style="font-size: 1.3em;"> <strong>Notice Board </strong><span class="glyphicon glyphicon-pushpin"></span></div>
            ...
            <div id="dg" class="animate-right col-sm-3">
                <div class="card drop-shadow" style="min-height: 138px">
                    ...
                    <div class="content dgbox">
                        ...
                        <p class="text-center"><button type="button" class="btn btn-default" id="btndg" onclick="window.location.href = &#39;http://tmis.nata.gov.bd/dg&#39;;">Details</button></p>
                    </div>
