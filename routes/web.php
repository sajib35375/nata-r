...
Route::get('show/dormatory',[App\Http\Controllers\AdminController::class,'showDormatory'])->name('show.dormatory');
...
//sms
Route::get('sms/send',[App\Http\Controllers\SmsController::class,'SmsSend'])->name('sms.send');
//batch status
...
//Route::post('signature/update',[App\Http\Controllers\CertificateController::class,'signatureUpdate'])->name('signature.update');
